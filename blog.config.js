...
const BLOG = {
  ...
  CUSTOM_MENU: process.env.NEXT_PUBLIC_CUSTOM_MENU || trues, // 支持Menu 类型，从3.12.0版本起，各主题将逐步支持灵活的二级菜单配置，替代了原来的Page类型，此配置是试验功能、默认关闭。
  ...
  KEYWORDS: process.env.NEXT_PUBLIC_KEYWORD || 'Airdrop, 空投，web3', // 网站关键词 英文逗号隔开
